      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" width="180">
          <template v-slot="scope">
            <el-button size="mini" type="primary" plain  @click=checkout(scope.row.id) :disabled="scope.row.outTime">退房</el-button>
...
export default {
  ...
  methods: {
    ...
    checkout(id){
      this.$request.get("/checkin/checkout/"+id).then(res=>{
        if (res.code === '200') {
