...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'type', name: 'Type', meta: { name: '房间分类信息' }, component: () => import('../views/manager/Type') },
      ...
      { path: 'order', name: 'Order', meta: { name: '客房信息' }, component: () => import('../views/manager/Order') },
  ...
  },
  {
    ...
    children: [
      { path: 'home', name: 'Homes', meta: { name: '系统首页' }, component: () => import('../views/front/Home') },
      { path: 'person', name: 'Person', meta: { name: '个人信息' }, component: () => import('../views/front/Person') },
      { path: 'hotel', name: 'Hotels', meta: { name: '酒店信息' }, component: () => import('../views/front/Hotel') },
      { path: 'detail', name: 'Detail', meta: { name: '客房信息' }, component: () => import('../views/front/Detail') },
      { path: 'collect', name: 'Collect', meta: { name: '客房信息' }, component: () => import('../views/front/Collect') },
